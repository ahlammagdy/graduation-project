...
class StaticLevel1UI extends StatefulWidget {
  const StaticLevel1UI({super.key});

  @override
  State<StaticLevel1UI> createState() => _StaticLevel1UIState();
}

class _StaticLevel1UIState extends State<StaticLevel1UI> {
  List<Widget> items = [
    TextFormField(
  ...
  Widget build(BuildContext context) {
    List<StaticLevel1Class> dummStaticLevel1list = [
      StaticLevel1Class(
        caseName: 'Blue water',
        diagnosies:
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            ...
            const Text("Read the written medicen and list it in the feilds ",
